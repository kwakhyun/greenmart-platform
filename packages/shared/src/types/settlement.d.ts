...
/** 결제 수단 */
export type PaymentMethod = "CREDIT_CARD" | "DEBIT_CARD" | "BANK_TRANSFER" | "VIRTUAL_ACCOUNT" | "KAKAO_PAY" | "NAVER_PAY" | "TOSS_PAY" | "POINTS";
/** 주문 항목 */
...
/** 정산 상태 */
export type SettlementStatus = "PENDING" | "CALCULATED" | "CONFIRMED" | "PAID" | "DISPUTED";
/** 정산 내역 */
